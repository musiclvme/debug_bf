...
if __name__ == "__main__":
    ...
    """
    input_file = ["examples/wtw_2m_90c_ajkj_1g270-100cm_mic1.pcm",
                  "examples/wtw_2m_90c_ajkj_1g270-100cm_mic2.pcm"]
    out_file = ["examples/wtw_2m_90c_ajkj_1g270-100cm_out.pcm"]
    config = {'add_AEC': 0, 'add_BF': 2, 'add_DOA': 0, 'mic_num': 2, 'ref_num': 0}
    mic_coord = [[-0.013, 0.0, 0.002],
                 [0.013, 0.0, 0.002]]
    """
