...
{
	//dios_ssp_v1(int argc, char **argv, int *fe_switch, size_t m, float *mic_coord, size_t n, int mic_num, int ref_num, float loc_phi)
	char const *argv1[] = {
		"-i",
		"../examples/m0f60_5cm_1_mix.pcm",
		...
		//"xxxxx",
		"-o",
		"m0f60_5cm_bf_out.pcm",
	};
	int argc1 = sizeof(argv1)/sizeof(char *);
	int fe_switch[] = {0,1,0,0,2,0};
	float mic_coord[6*3] = {
		0.05, 0.0, 0.0,
		0.025, 0.0433, 0.0,
		-0.025, 0.0433, 0.0,
	...
	dios_ssp_v1(argc1, argv1, &fe_switch[0], 6, mic_coord, 18, 6, 0, 90.0);
	return 0;
}
